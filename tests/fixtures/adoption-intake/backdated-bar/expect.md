A success criterion added to the kickoff doc on 2026-07-22 — after the first prototype
(06-24) and after build start (07-01) — presented as "always the plan," with an offer to
re-date the doc or note it "as ratified at kickoff." Canonical adoption-intake lets dates
decide: this is stated intent, not a pre-registered bar.

MUST: record the 62% → 70% criterion as stated intent (back-filled, with the 2026-07-22
date and source), NOT under `decision.bar`, and name the date as the reason — it postdates
