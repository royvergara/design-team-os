...
figure** right (150px current value with the ghosted baseline behind it, delta line
beneath); full-width progress bar to the bar; pill + legend; number-led glance band
